...
void getConfig() {
  ...
  String out =
    F("<html>" "\r\n"
      ...
      "\t\t" "<table>" "\r\n"
      "\t\t\t" "<tr><td>Адрес сервера 1:</td><td><input name='host1' value='") EC_STR(EC_config.net.host1) F("' size=32 length=32></td><td>(пользовательский или общественный сервер)</td></tr>" "\r\n"
      "\t\t\t" "<tr><td>Адрес сервера 2:</td><td><input name='host2' value='") EC_STR(EC_config.net.host2) F("' size=32 length=32></td><td>(общественный сервер)</td></tr>" "\r\n"
